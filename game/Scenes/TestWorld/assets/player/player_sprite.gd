...
onready var _stand = preload("res://Scenes/TestWorld/assets/player/textures/stand.png")
onready var _jump = preload("res://Scenes/TestWorld/assets/player/textures/jump.png")
onready var _run = preload("res://Scenes/TestWorld/assets/player/textures/run.png")
